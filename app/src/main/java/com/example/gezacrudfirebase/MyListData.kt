...
//Deklarasi Variable Database Reference & ArrayList dengan Parameter Class Model kita.
    ...
    private fun GetData() {
        ...
        getReference.child("Admin").child(getUserID).child("Mahasiswa").addValueEventListener(object : ValueEventListener {
...
RecyclerView
* melalui interface. kemudian akan menghapus data berdasarkan primary key dari
data tersebut
